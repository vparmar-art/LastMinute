...
class _RechargeScreenState extends State<RechargeScreen> {
  ...
  Future<void> _fetchPlans() async {
    final response = await http.get(Uri.parse('http://prod-lb-1092214212.us-east-1.elb.amazonaws.com/api/wallet/plans/'));
  ...
  void _pay() async {
    ...
    final response = await http.post(
      Uri.parse('http://prod-lb-1092214212.us-east-1.elb.amazonaws.com/api/wallet/recharge/'),
